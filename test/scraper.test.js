...
test('parseInitials and buildInitialUrl support all-initial scraping', () => {
  assert.deepEqual(parseInitials('A, Ł,Ż'), ['A', 'Ł', 'Ż']);
  assert.ok(parseInitials('ALL').includes('Ł'));
  assert.equal(
    buildInitialUrl('https://www.ipsb.nina.gov.pl/Search/Type,Biography/Initial,A/', 'Ł'),
